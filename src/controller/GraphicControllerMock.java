...
/**
 * The type Graphic controller mock.
 */
public class GraphicControllerMock {
    ...
    /**
     * Instantiates a new Graphic controller mock.
     *
     * @param inputFile the input file
     * @param maxHeight the max height
     * @param maxWidth  the max width
     */
    public GraphicControllerMock(File inputFile, int maxHeight, int maxWidth) {
