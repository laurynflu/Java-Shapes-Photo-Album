import album.*;
import controller.GraphicControllerMock;
...
/**
 * The type Mock model graphics test.
 */
public class MockModelGraphicsTest {
    /**
     * Go.
     *
    ...
    public void go() throws IOException {
        ...
        GraphicControllerMock controller = new GraphicControllerMock(input, maxWidth, maxHeight);
        ...
        assertEquals("Input: background rectangle (0,0) 33 94 248 800 800\n" +
                ...
                "Input: Turn on the Lights! ", log.toString());
    }
}
